...
from gettsim.tt import ConsecutiveIntLookupTableParamValue, TTSIMUnit, policy_function


@policy_function(start_date="2007-04-20", end_date="2030-12-31", unit=TTSIMUnit.YEARS)
def altersgrenze(
    geburtsjahr: int,
