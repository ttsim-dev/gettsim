...
@policy_input(start_date="1996-07-29", end_date="2009-12-31", unit=Unit.DIMENSIONLESS)
...
@policy_input(start_date="2004-07-26", end_date="2017-12-31", unit=Unit.DIMENSIONLESS)
