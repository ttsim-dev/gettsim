...
@policy_input(start_date="2021-01-01", unit=Unit.MONTHS)
...
@policy_input(start_date="2021-01-01", unit=Unit.DIMENSIONLESS)
def mean_entgeltpunkte() -> float:
    """Mean Entgeltpunkte during Bewertungszeiten."""


@policy_input(start_date="2021-01-01", unit=Unit.CURRENCY.PER_MONTH)
...
@policy_input(start_date="2021-01-01", unit=Unit.CURRENCY.PER_YEAR)
