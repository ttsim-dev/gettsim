...
@policy_function(end_date="2017-12-31", unit=Unit.DIMENSIONLESS)
...
@policy_function(start_date="2012-01-01", unit=Unit.DIMENSIONLESS)
...
@policy_function(start_date="2012-01-01", unit=Unit.MONTHS)
