...
from gettsim.tt import Unit, group_creation_function, policy_input
...
@group_creation_function(
    leaf_name="fg_id", end_date="2022-12-31", unit=Unit.DIMENSIONLESS
)
...
@group_creation_function(
    leaf_name="fg_id", start_date="2023-01-01", unit=Unit.DIMENSIONLESS
)
...
@group_creation_function(
    leaf_name="eg_id", end_date="2022-12-31", unit=Unit.DIMENSIONLESS
)
...
@group_creation_function(
    leaf_name="eg_id", start_date="2023-01-01", unit=Unit.DIMENSIONLESS
)
